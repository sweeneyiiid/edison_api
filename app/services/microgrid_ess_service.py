...
DATABASE_NAME = 'microgrid-ess' #could also be table name

class MicroGridESSImport():
    """
    Class to Import MicroGrid ESS Service
    Step1: Get Post data and token
    Step2: Get ESP name from post token (TODO: move to shared service)
    Step3: Validate data
    Step4: Save to Mongo DB (Add  timestamp and any other required info to each post)
    """
